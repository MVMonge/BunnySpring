...
public class NewLevelWindow extends JFrame{
	...
	public NewLevelWindow(Bunny b)
	{
		ventana= new JFrame("New Level");
		colvalues=6;
		filvalues=4;
        ...
        message= new JLabel(" \t\t\t¡Felicitaciones!\t\t\t \n");
		message_1= new JLabel("\t\t\tPuntos:" + (b.getTotalPoints())+"\t\t\t  \n\n");
		message_2= new JLabel("\t\t\t Has pasado al nivel "+ b.getLevel()+"\t\t\t \n");
		playbutton= new JButton("NUEVO NIVEL");
		playbutton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Window w = new Window(b);/*ACA VA LA CANTIDAD DE ZANAHORIAS, ASI QUE TENGO QUE IR ARMANDO EL CATALOGO DE NIVELES*/
			}
